...
export default function CartSidebar() {
  ...
  console.log('Rendering CartSidebar') // Add debugging to confirm single render
        ...
        <div className='p-2 h-full flex flex-col gap-2 justify-start items-center'>
          <div className='text-center space-y-2'>
            ...
            <div className='font-bold'>
              <ProductPrice price={Number(itemsPrice)} plain />
            </div>
              ...
              <div key={item.clientId}>
                <div className='my-3'>
                  ...
                  <div className='text-sm text-center font-bold'>
                    <ProductPrice price={Number(item.price)} plain />
                  </div>
