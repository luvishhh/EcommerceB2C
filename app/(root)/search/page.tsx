...
import { getAllProducts, getAllTags } from '@/lib/actions/product.action'
              ...
              <ul>
                ...
                {categories.map((c: Category) => (
                  <li key={c.name} className='space-y-2'>
                    ...
                    {c.subCategories.length > 0 && c.name === category && (
                      <ul className='pl-4 space-y-1'>
                        {c.subCategories.map((sub: SubCategory) => (
                          <li key={sub.name}>
                            <Link
                              className={`${
                                sub.name === subCategory && 'text-primary'
                              }`}
                              href={getFilterUrl({
                                category: c.name,
